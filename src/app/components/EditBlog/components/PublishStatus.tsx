...
export const PublishStatus: React.FC = () => {
  ...
  const getStatusColor = () => {
    switch (status) {
      ...
      case 'draft': return 'bg-gray-50 text-gray-600 ring-gray-500/20';
    }
  };

  return (
    <div className={`inline-flex items-center rounded-md px-2 py-1 text-sm font-medium ring-1 ring-inset ${getStatusColor()}`}>
