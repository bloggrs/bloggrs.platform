...
export const IntegrationsPanel: React.FC<IntegrationsPanelProps> = ({ integrations }) => {
  return (
    <div className="p-8">
      <div className="max-w-5xl mx-auto">
        <section className="space-y-6">
          <div className="flex items-center justify-between mb-8">
            <h3 className="text-2xl font-semibold text-gray-800">Connected Services</h3>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200">
            {Object.entries(integrations).map(([service, config]) => (
              <div key={service} className="p-5 border-b border-gray-100 last:border-b-0">
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    {config?.enabled && (
                      <span className="text-sm text-gray-500 mt-1">Connected and ready</span>
                    )}
                  </div>
