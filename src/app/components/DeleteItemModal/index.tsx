...
const schema = yup.object().shape({
  confirmation: yup.string().test("valid", "Does not match..", val => val === "CONFIRM").required(),
})
            ...
            >
                ...
                <form className="modal-content" onSubmit={handleSubmit}>
                    ...
                    <div className="modal-footer">
                        <button disabled={isSubmitting} onClick={closeModal} type="button" className="btn btn-soft-secondary btn-sm">
                            Cancel
                        </button>
                        <button
                        type="submit"
