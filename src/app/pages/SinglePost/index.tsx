...
const SinglePost = props => {
    ...
    const [ status, setStatus ]: [ "NONE" | "ARCHIVE" | "DRAFT" | "PUBLISHED", Function ] = useState("NONE")
                ...
                <div className="card posts-rightbar" style={{
                    ...
                    <div className="card-body">    
                        <div className="button-items" style={{ display: "inline-grid", width: "100%" }}>
                            ...
                            <div>
                                <label className="mt-2 col form-label mb-lg-0 text-end">Thumbnail: </label>
                                <UploadFile 
                        ...
                        <hr/>
                        <SelectCategories initialValue={categories} onChange={setCategories} />
