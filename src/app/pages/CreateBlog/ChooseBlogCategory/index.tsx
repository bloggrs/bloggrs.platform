...
export const ChooseBlogCategory = ({
  ...
  const [blogCategoryId, setBlogCategoryId] = useState(parentValue);
  ...
  if (blogCategoryId) {
    ...
    if (found) {
      ...
      blogCategories_ = [
        createBlogCategory(blogCategoryId),
        ...blogCategories_,
      ];
    }
  }
      ...
      <div className="col-9">
        <div className="card-body">
          <div className="input-group col-sm-8 mt-2 col form-label">
            <label
              className="col-sm-3 mt-2 col form-label"
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="https://gblog.gjergjkadriu.com/" target="_blank">
                        ...
                        {slugify(blogCategory.name).toLowerCase()}
                      </a>
                    </td>
                    <td className="text-end">
                      <div className="form-check">
                        ...
                        >
                          {String(blogCategoryId) === String(blogCategory.id)
                            ? 'Selected'
                            : 'Select'}
                        </button>
                      </div>
