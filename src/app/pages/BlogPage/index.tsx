  ...
  const featuredPosts: BlogPost[] = [
    {
      ...
      excerpt:
        "Learn the latest strategies and techniques to expand your blog's reach and engage with more readers.",
      author: 'Content Team',
      date: 'March 15, 2024',
      readTime: '8 min read',
      category: 'Growth',
    ...
    },
    {
      ...
      excerpt:
        "Master the fundamentals of SEO to improve your blog's visibility and attract organic traffic.",
      author: 'SEO Expert',
      date: 'March 12, 2024',
    ...
    },
    {
      ...
      excerpt:
        'Discover various ways to generate income from your blog while maintaining authenticity.',
        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center">
            ...
            <div className="flex justify-center gap-4">
              <Link
                to="/blogs/create"
                className="bg-[#f4a261] hover:bg-[#e76f51] px-6 py-2.5 rounded-lg font-medium transition-colors"
              >
                Start Your Blog
              </Link>
              <a
                href="#latest"
                className="bg-gray-700 hover:bg-gray-600 px-6 py-2.5 rounded-lg font-medium transition-colors"
              >
                Read Latest Posts
              </a>
            </div>
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button className="text-[#f4a261] hover:text-[#e76f51] font-medium transition-colors">
                    Read More →
                  </button>
                </div>
              </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 mb-12">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-slate-600 mb-6">
              Get the latest blogging tips and platform updates delivered
