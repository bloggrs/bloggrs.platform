                ...
                <div className="col-lg-5 mx-auto">
                    ...
                    <div className="card-body p-0 auth-header-box">
                        ...
                        <Link to="/"  className="logo logo-admin">
                            <img src="/dist/static/image1.png" height={150} alt="logo" className="auth-logo" />
                        </Link>
                    ...
                    <div className="card-body">
                        ...
                        <a className="btn btn-primary w-100 waves-effect waves-light" href="/">Back to Dashboard <i className="fas fa-redo ms-1" /></a>                         
                    </div>
