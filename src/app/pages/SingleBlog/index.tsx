...
import { ChartBarIcon, UsersIcon, CogIcon, RssIcon, ArrowTopRightOnSquareIcon as ExternalLinkIcon } from '@heroicons/react/24/outline';
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
              ...
              <div className="border-t border-gray-200">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 divide-y md:divide-y-0 md:divide-x divide-gray-200">
                  ...
                  <div className="p-6 space-y-1">
                    <h6 className="text-sm font-medium text-gray-500">Monthly Views</h6>
                    <p className="text-gray-900">{stats.views}</p>
                    <p className="text-green-600 text-sm">↑ 12% from last month</p>
                  </div>
                  <div className="p-6 space-y-1">
                    <h6 className="text-sm font-medium text-gray-500">Subscribers</h6>
                  ...
                  <div className="p-6 space-y-1">
                    <h6 className="text-sm font-medium text-gray-500">Engagement Rate</h6>
          ...
          <div className="w-full lg:w-80 space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-medium text-gray-900">2m 35s</span>
                </div>
                <div className="flex items-center justify-between">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-3">
                <a href="#" className="block text-sm text-gray-600 hover:text-[#1a365d]">
