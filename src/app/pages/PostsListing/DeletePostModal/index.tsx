...
export const DeletePostModal = ({ post: { id, title }, children }: DeletePostModalProps) => {
    ...
    return (
      <div>
        ...
        >
          ...
          <h1 className="text-2xl text-slate-700 font-medium">Delete '{title}' post</h1>
          <h1 className="text-xl text-slate-700 font-bold">Are you sure you want to perform this action?</h1>
          <span style={{
            textAlign: "left",
          ...
          {/* <div>I am a modal</div> */}
            <div className="flex w-6/6" style={{
                ...
                <div className="w-11/12">
                    <button onClick={onDelete(id)} className=" btn-base w-52 bg-red-500  text-white rounded-full hover:bg-red-500">
                        Delete
                    </button>
                </div>
                <br/>
